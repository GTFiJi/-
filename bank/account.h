...
private:
    ...
    static multimap<Date, AccountRecord> recordMap;		//所有账目,用于后面STL模板在account.cpp

public:
	//构造函数
    Account(const Date &date, string id, string User);// 由派生类，s，c来实现
    ...
    void record(Date &date,double amount,string desc);		//记录操作
